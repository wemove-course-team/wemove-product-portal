...
用户已确定Docker部署到Linux：chenyi-c负责Compose/Nginx/前端镜像及服务器发布；cy0207kaw负责后端/迁移镜像、健康检查和代理会话；Snowed-night负责MySQL卷、迁移与恢复；22099yang负责上传卷路径；GLOCKDDD在Linux部署上验收，lizhikeer负责真实站点UI。这些部署要求纳入原任务，不新增里程碑。
...
| chenyi-c | 11 | 运营、Docker/Linux部署与交付协调 |

合计70小时领域工作，另14小时全员共同工作，共84小时规划投入，已给Docker/Linux部署额外增加2小时。3天按每人6有效小时提供126小时容量，余量用于学习、联调与缺陷。仅2天时先删7小时P1，再将最终UI控制为3小时、性能处理1小时；GLOCKDDD协助cy0207kaw完成约2小时账户后台，22099yang协助chenyi-c约1小时部署检查，使个人负荷控制在约12小时。首次配置服务器的耗时仍需在B00核实，不用固定估算掩盖环境阻碍。
